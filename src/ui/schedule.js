...
// panels that draw state (build cards, upgrade cards, milestones, log, city hall) only need a
// pass on frames where the tick advanced or such an event landed; the frames in between (five
// of every six at 60 fps) only need the HUD's tweens and the skyline's animation. The api
